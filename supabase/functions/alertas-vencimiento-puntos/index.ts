...
//
// v2 (sonido predeterminado del sistema — pedido explícito del usuario): se
// agrega `android.notification.sound: 'default'` al payload de FCM para que
// la alerta preventiva de vencimiento suene con el tono predeterminado del
// dispositivo Android, en vez de llegar en silencio.
//
