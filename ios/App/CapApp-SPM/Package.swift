...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CordovaPluginGeofence", path: "../../capacitor-cordova-ios-plugins/sources/CordovaPluginGeofence")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
            dependencies: [
                ...
                .product(name: "CordovaPluginGeofence", package: "CordovaPluginGeofence")
            ]
        )
    ]
)
